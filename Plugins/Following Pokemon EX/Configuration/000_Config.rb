module FollowingPkmn
  ...
  ANIMATION_COME_IN         = 543

  ANIMATION_EMOTE_HEART     = 549

  ANIMATION_EMOTE_MUSIC     = 548

  ANIMATION_EMOTE_HAPPY     = 544

  ANIMATION_EMOTE_ELIPSES   = 545

  ANIMATION_EMOTE_ANGRY     = 546

  ANIMATION_EMOTE_POISON    = 547
